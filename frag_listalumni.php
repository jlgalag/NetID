<?php
	...
	if($activerole=='student' || $activerole=='employee' || $activerole == 'alumni')
	 ...
	 $result  = ldap_search($ldapconn, "ou=people,".$ldapconfig['basedn'], "(&(coursegraduated=".$degprog.")(title=alumni))");
            ...
            <div class="span9">
			    <div class="hero-unit">
					...
					<?php 
						 ...
						 echo '<a href="frag_listalumni.php?dp='.$degprog.'&orderby=sn">Name</a> <span class="divider">/</span></li>';
						 if ($orderby=="yeargraduated") echo '<li class="active">';						   
						 else                           echo '<li>';
						 echo '<a href="frag_listalumni.php?dp='.$degprog.'&orderby=yeargraduated">Year Graduated</a> <span class="divider">/</span></li>';
						 if ($orderby=="mail") echo '<li class="active">';						   
						 else                  echo '<li>'; 
						 echo '<a href="frag_listalumni.php?dp='.$degprog.'&orderby=mail">Mail</a> </li>';
					  ?>
					</ul>
					...
					<?php
			      		    echo '<table class="table" id="tablelist" style="font-size:14px;">
									...
									for($i=0; $i<count($entries)-1; $i++){
									   echo "<tr>";
											echo 	"<td><a  style='color:#333333' href='viewprofile.php?title=alumni&uid=".$entries[$i]['uid'][0]."'";  
											...
											echo 	"<td>".$entries[$i]['coursegraduated'][0]."</td>";
											echo 	"<td>".$entries[$i]['yeargraduated'][0]."</td>";
