<?php
	...
	//User with ADMIN can view this page
	if($activerole=='student' || $activerole=='employee' || $activerole == 'HRDO' || $activerole == 'OUR' || $activerole == 'OCS')
	   redirect("home.php");
	   
	 $orderby=$_GET['orderby'];
	 // search for the deactivated employees
	 $result  = ldap_search($ldapconn, "ou=disabledaccounts,".$ldapconfig['basedn'], "title=employee");
...
<head>
    <?php
     $pagetitle = "NetID :: Deactivated Employee List";
	 include 'header.php';
    ?>
					...
					<div id="pagination" class="pagination pagination-small">
					 ...
					 <ul class="inline pull-right" style="font-size:12px; margin-top:-30px">
					    ...
					    <?php 
						 ...
						 echo '<a href="frag_disabled_employee.php?&orderby=sn">Name</a> <span class="divider">/</span></li>';
						 if ($orderby=="studentnumber") echo '<li class="active">';						   
						 else                           echo '<li>';
						 echo '<a href="frag_disabled_employee.php?&orderby=employeenumber">Emp Number</a> <span class="divider">/</span></li>';
						 if ($orderby=="ou") echo '<li class="active">';						   
						 else                  echo '<li>'; 
						 echo '<a href="frag_disabled_employee.php?&orderby=employeetype">Type</a> <span class="divider">/</span></li>';
						 if ($orderby=="ou") echo '<li class="active">';						   
						 else                  echo '<li>'; 
						 echo '<a href="frag_disabled_employee.php?&orderby=ou">Unit</a> <span class="divider">/</span></li>';
						 if ($orderby=="mail") echo '<li class="active">';						   
						 else                  echo '<li>'; 
						 echo '<a href="frag_disabled_employee.php?&orderby=mail">Mail</a> </li>';
					   ?>
					</ul>
					<?php
					         echo '<table class="table" id="tablelist" style="font-size:14px;">
									...
									for($i=0; $i<count($entries)-1; $i++){
									   echo "<tr>";
											echo 	"<td><a style='color:#333333' href='viewprofile_dis.php?title=employee&uid=".$entries[$i]['uid'][0]."'";
