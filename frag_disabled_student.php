<?php
	...
	//User with ADMIN privelages can only view this page
	if($activerole=='student' || $activerole=='employee' || $activerole == 'HRDO' || $activerole == 'OUR' || $activerole == 'OCS')
	   redirect("home.php");
	
	 $orderby=$_GET['orderby'];
	 //search for the deactivated students
	 $result  = ldap_search($ldapconn, "ou=disabledaccounts,".$ldapconfig['basedn'], "title=student");
...
<head>
    <?php
     $pagetitle = "NetID :: Deactivated Student List";
	 include 'header.php';
    ?>
            ...
            <div class="span9">
			    <div class="hero-unit">
					...
					<?php 
						 ...
						 echo '<a href="frag_disabled_student.php?dp='.$degprog.'&orderby=sn">Name</a> <span class="divider">/</span></li>';
						 if ($orderby=="studentnumber") echo '<li class="active">';						   
						 else                           echo '<li>';
						 echo '<a href="frag_disabled_student.php?dp='.$degprog.'&orderby=studentnumber">Student number</a> <span class="divider">/</span></li>';
						 if ($orderby=="mail") echo '<li class="active">';						   
						 else                  echo '<li>'; 
						 echo '<a href="frag_disabled_student.php?dp='.$degprog.'&orderby=mail">Mail</a> </li>';
					  ?>
					</ul>
					...
					<?php
			      		    echo '<table class="table" id="tablelist" style="font-size:14px;">
									...
									for($i=0; $i<count($entries)-1; $i++){
									   echo "<tr>";
											echo 	"<td><a  style='color:#333333' href='viewprofile_dis.php?title=student&uid=".$entries[$i]['uid'][0]."'";  
