...
if(isset($_SESSION['vercode2']))
{
unset($_SESSION['vercode2']); // destroy the session if already there
}
//else{
...
$_SESSION['vercode2'] =$random_text; // Assign the random text to session variable

//echo $_SESSION['vercode2'] . "<br/>";
//echo $random_text;
///// Create the image ////////
...
//echo $_SESSION['vercode2'];#$random_text;
//}?>
